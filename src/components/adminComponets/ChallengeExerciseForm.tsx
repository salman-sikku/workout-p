...
const ChallengeExerciseForm: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    e.preventDefault();
    try {
      const response = await axios.post('/api/challenge-exercise/challengPost', formData);
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl mx-auto p-4 bg-white shadow-md rounded-md">
      <h1 className="text-2xl font-bold mb-4">Challenge Exercise Form</h1>
      <div className="mb-4">
...
export default ChallengeExerciseForm;
